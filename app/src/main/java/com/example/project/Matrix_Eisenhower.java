...
public class Matrix_Eisenhower extends AppCompatActivity {
    ...
    private void setupPriorityClickListeners() {
        ...
        if (priority1Layout != null) {
            priority1Layout.setOnClickListener(v -> navigateToSingleMatrix(1, getString(R.string.matrix_urgent_important)));
        }
        ...
        if (priority2Layout != null) {
            priority2Layout.setOnClickListener(v -> navigateToSingleMatrix(2, getString(R.string.matrix_important_not_urgent)));
        }
        ...
        if (priority3Layout != null) {
            priority3Layout.setOnClickListener(v -> navigateToSingleMatrix(3, getString(R.string.matrix_urgent_not_important)));
        }
        ...
        if (priority4Layout != null) {
            priority4Layout.setOnClickListener(v -> navigateToSingleMatrix(4, getString(R.string.matrix_not_urgent_not_important)));
        }
    }
